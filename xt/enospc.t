...
use Data::Log::Shared;
my ($mnt, @args) = @ARGV;
my $h = eval { Data::Log::Shared->new("$mnt/x.shm", @args) };
print $h ? "created\n" : "refused: $@";
P
close $fh;
...
($sig, $out) = on_small_tmpfs('DATA_LOG_SHARED_SPARSE=1', 16 << 20);
is $sig, SIGBUS, 'DATA_LOG_SHARED_SPARSE=1 skips the reservation';
